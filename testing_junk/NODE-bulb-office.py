...
DEVICEID = "ebfc16d57ed374932cjqfk"   # "ebe097c0407da32084kvtr" #"ebfc16d57ed374932cjqfk"
...
for level in range(3):
    print('    Level: %d%%' % (level*5))
    d.set_brightness_percentage(level*5)
    time.sleep(1)    
